...
function c(str) {
  // prevents calc from overflowing, also removes 0 from the beginning
  if (reset === true) {
    clear();
  }
...
const operators = {
  // idea from https://stackoverflow.com/questions/14653647/how-to-store-operator-in-variable-using-javascript
  "+": function (a, b) {
    return a + b;
  },
  "-": function (a, b) {
